<div class="card blocks-accordion__card">
    <div class="card-header blocks-accordion__card-header" id="accordionBlockGroup{{ $block->blockGroup->slug }}Heading{{ $block->slug }}">
        <a class="btn btn-block text-left{{ !empty($first) ? "" : " collapsed" }}"
    ...
    <div id="collapse{{ $block->slug }}"
         class="collapse blocks-accordion__collapse{{ !empty($first) ? " show" : "" }}"
